...
@section('product')
    ...
    <div class="badan"> 
    		<div class="list-produk">
            	<img src="{{ url ('assets/img/onemake/product/cat/e.png') }}" alt="paint5">
 	        	<h5>{{trans('product.deco1-header1')}}</h5>
                    <a class="tombol1 tombol-exterior" href="#"> {{trans('product.deco1-tag1')}}</a>
                            <a class="tombol1 tombol-interior" href="#">{{trans('product.deco1-tag2')}}</a>
            ...
            <div class="list-produk">
                <img src="{{ url ('assets/img/onemake/product/cat/c.png') }}" alt="paint5">
        ...
        <div class="list-produk">
                <img src="{{ url ('assets/img/onemake/product/cat/d.png') }}" alt="paint5">
      ...
      <div class="list-produk">
                <img src="{{ url ('assets/img/onemake/product/cat/f.png') }}" alt="paint5">
                <h5>{{trans('product.deco7-header1')}}</h5>
               <!--    <a class="tombol1 tombol-interior" href="#">Interior</a> -->
                      <a class="tombol1 tombol-exterior" href="#">{{trans('product.deco1-tag2')}}</a>
            ...
            <div class="list-produk">
                <img src="{{ url ('assets/img/onemake/product/cat/g.png') }}" alt="paint5">
