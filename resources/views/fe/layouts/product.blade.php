...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="cms-pg-top">
	<head>
		...
		<link rel="stylesheet" type='text/css' href="{{ asset('css/fe/products.min.css') }}" />
	...
	<body id="body" class="">
		...
		<script type="text/javascript" src="{{ asset('js/fe/products.min.js') }}"></script>
		...
		<!-- <script>
		VANTA.NET({el: "#body",color: 0x7013,
